...
- Paper review boards (per `docs/ops/retail-ui/paper/HEDGR_PAPER_REVIEW_BOARD_CONVENTION.md`)  
- prototype variants and readouts (e.g. `docs/ops/retail-ui/paper/HEDGR_RETAIL_UI_PAPER_REVIEW_READOUT.md`)  
