...
| No governance override evidence | Incident response / operational failure evidence package | Evidence missing | Future governed review required | Pause, halt, manual exception, override, or authority-boundary review |
...
| No approval-chain evidence | Audit / retention / access-control evidence package; ADR drafting readiness evidence package | Evidence missing | Future governed review required | ADR drafting readiness; implementation-proposal preflight |
