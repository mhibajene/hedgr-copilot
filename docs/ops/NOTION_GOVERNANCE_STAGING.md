...
**Last reconciled:** 2026-05-15 (`HEDGR_STATUS.md` **§7** completed through **`GOV-B-009`**; post–**`MC-S3-019`** documentation-only governance: **`COP-GOV-001`** PR **#150** / **§52**; **`MC-S3-020`** PR **#153** (readout / **§7** activation **#152**) / **§53**; **`GOV-B-001`**–**`GOV-B-009`** **§54**–**§62**; **§7** / **§7a** remain **no active ticket**)
...
- `docs/ops/HEDGR_STATUS.md` §2, §3, §6, §6b, §6c, §7, §7a, §37–§62 (§37 — **`MC-S3-006`**; §38 — **`MC-S3-007`**; §39 — **`MC-S3-008`**; §40 — **`MC-S3-009`**; §41 — **`MC-S3-010`**; §42 — **`MC-S3-011`**; §43 — **`MC-S3-012`**; §44 — **`UI-SRA-001`**; §7 completed-list entry — **`UI-USH-001`**; §45 — **`MC-S3-013`**; §46 — **`MC-S3-014`**; §47 — **`MC-S3-015`**; §48 — **`MC-S3-016`**; §49 — **`MC-S3-017`**; §50 — **`MC-S3-018`**; §51 — **`MC-S3-019`**; §52 — **`COP-GOV-001`**; §53 — **`MC-S3-020`**; §54 — **`GOV-B-001`**; §55 — **`GOV-B-002`**; §56 — **`GOV-B-003`**; §57 — **`GOV-B-004`**; §58 — **`GOV-B-005`**; §59 — **`GOV-B-006`**; §61 — **`GOV-B-008`**; §62 — **`GOV-B-009`** merged records)
...
| **Doctrine traceability** | ADR **0013**, **0014**, **0015**, **0016** (boundary), **0017** (where relevant); closeout records **ADR 0018–0022**; Decision Log **D-023** / **D-024** / **D-025** (MC-S3-006 / MC-S3-007 / MC-S3-008 — **Notion mirrors**, no ticket-intent repo ADR); canonical ops **`HEDGR_STATUS.md`** (**§52–§62** for post–**MC-S3-019** governance spine). |
...
## 13. Drift review checklist (post–`GOV-B-009` / repo **`§7`** through **`§62`**)
...
| **Phase 2 - Trust Expression** | Ensure wording does **not** read as **approved next queue**; repo sequencing is **§7** only; include **`MC-S3-019`** and post–TR **`§7`** governance completions through **`GOV-B-009`** when listing merged history. |
...
| **Work: MC-S3-009 through MC-S3-019 / UI-SRA-001 / UI-USH-001 / COP-GOV-001 / MC-S3-020 / GOV-B-001–GOV-B-009** | Use **§12b** snapshot for missing-row reconciliation; keep each row complete/merged and non-sequencing. |
