...
**Last reconciled:** 2026-06-26 (`HEDGR_STATUS.md` **§7** names active **`OFFRAMP-GOV-001`** with a bounded **§7a** brief; framework checkpoint recorded in **§6**; prior completed truth remains through **`BRAND-009`** (**§107**), **`MC-S3-022`** (**§106**), **`BRAND-008`** (**§105**), **`MC-S3-021`** (**§104**), **`SE-POSTURE-001`** (**§103**), **`SE-VAL-001`** (**§102**), **`DOC-SE-REF-001`** (**§101**), **`UI-ALG-001`** (**§100**), **`GOV-INTAKE-B-002`** (**§99**), Class B evidence program **§74**–**§98**, Class B spine **§54**–**§65d** / **§73**, and Brand System Governance through **`BRAND-009`**; research-promotion closeout remains pending under the active ticket close order)
...
- **`OFFRAMP-GOV-001` (active, documentation-only governance):** Off-Ramp Governance Framework — establishes off-ramp as a doctrine-informed cross-cutting governance framework subordinate to the Constitutional Charter, MVP doctrine, Stability Engine read-only boundaries, and Class B governance / evidence architecture; framework checkpoint recorded in **`HEDGR_STATUS.md` §6**. This does **not** create an independent governance institution and does **not** authorize evidence intake, evidence acceptance, provider selection, market selection, provider outreach, ADR acceptance, implementation, staging, sandbox use, internal testing, live operations, custody, rails, stablecoin conversion, treasury operations, reconciliation operations, support operations, audit operations, ledger truth, accounting truth, Copilot execution, Class C automation, or customer fund movement. Research promotion remains pending until the framework is merged under the active ticket close order.
...
## 9g. Releases — Off-Ramp Governance Framework (active copy row)
...
| **Status** | Active / framework checkpoint |
| **Type** | Documentation-only / cross-cutting governance framework |
| **Authority** | Non-authorizing |
| **Repo authority** | `docs/ops/HEDGR_STATUS.md` **§7** / **§7a** |
| **Scope** | `OFFRAMP-GOV-001` framework-first close order: framework merge before research promotion |
| **Description** | Establishes off-ramp as a doctrine-informed cross-cutting governance framework under Class B governance, not as an independent institution and not as a provider/market implementation path. The framework documents institutional role, constitutional alignment, liquidity integrity relationship, responsibility model, Stability Engine informational boundary, Market Strategy relationship, Trust UX relationship, Class B evidence architecture, implementation gates, dependencies, terminology, and non-accepting ADR candidate domains. |

### Off-Ramp Governance Framework work items

| Ticket | Title | Status | Type | Authority | Summary |
| ------ | ----- | ------ | ---- | --------- | ------- |
| `OFFRAMP-GOV-001` | Establish Hedgr Off-Ramp Governance Framework | Active / framework checkpoint | Documentation-only governance framework | Non-authorizing | Creates `docs/ops/governance/offramp/HEDGR_OFFRAMP_GOVERNANCE_FRAMEWORK.md` and records the framework checkpoint in `HEDGR_STATUS.md` **§6**. Research artifacts remain review drafts / decision-support inputs until the framework is merged and the active ticket proceeds to the research-promotion closeout step. |
...
| **Executive / Strategy surfaces** | Current repo **§7** names active **`OFFRAMP-GOV-001`** and **§7a** holds the bounded active execution brief. The framework checkpoint is recorded in **§6**; research-promotion closeout remains pending until after framework merge. Last completed ticket remains **`BRAND-009`** (shared-UI semantic token normalization, **§107**) until `OFFRAMP-GOV-001` closes. Brand System Governance spine plus first two remediation steps (**`BRAND-001`**–**`BRAND-009`**, **§6d** / **§66**–**§72** / **§105** / **§107**) are complete; no successor Brand ticket unless **§7** names one. Do **not** copy stale no-active-ticket language, treat the off-ramp framework as provider / market / evidence / implementation authority, or treat **`SE-POSTURE-001`** / **`DOC-SE-REF-001`** / **`UI-ALG-001`** / **`GOV-INTAKE-B-002`** / **`MC-S3-021`** / **`BRAND-008`** / **`MC-S3-022`** as the last completed ticket. |
