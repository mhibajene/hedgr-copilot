...
This document converts `docs/ops/retail-ui/paper/HEDGR_RETAIL_UI_SCREEN_ANATOMY_COMPARISON.md` into ultra-low-fidelity dashboard wire descriptions for critique.
