...
- `docs/ops/retail-ui/implementation-readouts/HEDGR_RETAIL_UI_SHIPPED_ROUTE_ADAPTATION_EXECUTION_REQUEST.md`
...
Compact restatement of the slice (mirrors `docs/ops/retail-ui/implementation-readouts/HEDGR_RETAIL_UI_SHIPPED_ROUTE_ADAPTATION_EXECUTION_REQUEST.md` **§3**):

**Shipped-route adaptation** in `apps/frontend/app/(app)/dashboard/**` only, to reflect the **settled money-first reference surface** (`docs/ops/retail-ui/paper/HEDGR_RETAIL_UI_MOCKUP_REFERENCE_SURFACE_NOTE.md`), limited to:
...
- **Requires:** rollback posture and regression-contract review per `docs/ops/retail-ui/implementation-readouts/HEDGR_RETAIL_UI_SHIPPED_ROUTE_ADAPTATION_EXECUTION_REQUEST.md` **§8–§9** and `AGENTS.md` (Vitest / E2E / engine-trust surfaces as applicable).
...
- Implementation must remain **subordinate to the settled reference surface** (`docs/ops/retail-ui/paper/HEDGR_RETAIL_UI_MOCKUP_REFERENCE_SURFACE_NOTE.md`); no competing design pass.
