...
Alignment inputs: `docs/ops/HEDGR_STATUS.md`, `AGENTS.md`, `docs/ops/retail-ui/header/HEDGR_RETAIL_UI_UPPER_SHELL_CONTINUATION_IMPLEMENTATION_PROMPT.md`, `docs/ops/retail-ui/header/HEDGR_RETAIL_UI_UPPER_SHELL_CONTINUATION_BRIEF.md`, `docs/ops/retail-ui/header/HEDGR_RETAIL_UI_UPPER_SHELL_CONTINUATION_READOUT.md`, and the repo diff for the ticket’s touched files.
