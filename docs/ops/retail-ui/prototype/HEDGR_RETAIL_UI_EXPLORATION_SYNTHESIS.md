...
1. `docs/ops/stability-engine/HEDGR_STABILITY_ENGINE_UI_EXPLORATION_NOTE.md`
...
2. `docs/ops/stability-engine/HEDGR_STABILITY_ENGINE_UI_VARIANT_DISPOSITION.md`
...
3. `docs/ops/governance/mvp/HEDGR_ATLAS_PRODUCT_CONCEPT_NOTE.md`
...
5. `docs/ops/stability-engine/HEDGR_STABILITY_ENGINE_TRUST_SURFACE_TEST_COVERAGE_MATRIX.md`
