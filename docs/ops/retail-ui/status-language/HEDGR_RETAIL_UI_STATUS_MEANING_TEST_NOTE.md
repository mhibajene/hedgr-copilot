...
- `docs/ops/retail-ui/status-language/HEDGR_RETAIL_UI_PASS_RESOLUTION_NOTE.md` — accept / translate / defer; Stability Status “more meaning” and supporting-line direction.
- `docs/ops/retail-ui/status-language/HEDGR_RETAIL_UI_MEANING_REFINEMENT_BRIEF.md` — next meaning-refinement cycle; §6.1 Stability Status meaning and §6.5 bounded status vocabulary.
...
- `docs/ops/retail-ui/prototype/HEDGR_RETAIL_UI_C3_REFINEMENT_BRIEF.md` — C3 order; Stability Status placement in the stack.
- `docs/ops/retail-ui/prototype/HEDGR_RETAIL_UI_CRITIQUE_SCORECARD.md` — doctrine-safe evaluation language (trust legibility, calmness, hierarchy).
