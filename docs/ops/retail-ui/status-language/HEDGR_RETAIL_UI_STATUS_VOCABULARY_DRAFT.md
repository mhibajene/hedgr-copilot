...
- `docs/ops/retail-ui/status-language/HEDGR_RETAIL_UI_STATUS_LANGUAGE_GUARDRAILS.md` — interpretive vs operational bounds; acceptable pattern types; out-of-bounds language; core principles.
- `docs/ops/retail-ui/status-language/HEDGR_RETAIL_UI_STATUS_COPY_MICRO_TEST_READOUT.md` — same-frame A / B / C signal; Treatment B as working centerline; unresolved semantics.
- `docs/ops/retail-ui/status-language/HEDGR_RETAIL_UI_MEANING_REFINEMENT_BRIEF.md` — §6.1 Stability Status meaning; §6.5 bounded status vocabulary; translate-before-use themes.

**Supporting context:**

- `docs/ops/retail-ui/status-language/HEDGR_RETAIL_UI_STATUS_COPY_MICRO_TEST.md` — micro-test definition; same-frame discipline; explicit out-of-scope list.
- `docs/ops/retail-ui/status-language/HEDGR_RETAIL_UI_STATUS_COPY_COMPARISON.md` — bounded copy directions; comparative criteria; separation of interpretation, engine exposure, and advisory.
- `docs/ops/retail-ui/status-language/HEDGR_RETAIL_UI_STATUS_MEANING_TEST_NOTE.md` — “meaning without machinery” frame; supporting-line test; evaluation criteria.
- `docs/ops/retail-ui/status-language/HEDGR_RETAIL_UI_PASS_RESOLUTION_NOTE.md` — accept / translate / defer; bounded supporting-line direction; deferred state machine and risk labels.
- `docs/ops/retail-ui/prototype/HEDGR_RETAIL_UI_PROTOTYPE_CRITIQUE_READOUT.md` — prototype reality; status language under ongoing scrutiny.
