...
This document records the outcome of the **same-frame allocation-pattern micro-test** defined in `docs/ops/retail-ui/allocation/HEDGR_RETAIL_UI_ALLOCATION_PATTERN_MICRO_TEST.md`, comparing **Pattern A**, **Pattern B**, and **Pattern C** for the **Allocation / Trust Detail** layer on the calm-money **C3** retail dashboard baseline.
...
Nothing in this document is an **approved final UI pattern**, implementation mandate, or product decision. It is **critique readout only**, subordinate to `docs/ops/HEDGR_STATUS.md` and `AGENTS.md`, and aligned with the allocation legibility framing in `docs/ops/retail-ui/allocation/HEDGR_RETAIL_UI_ALLOCATION_LEGIBILITY_BRIEF.md`, `docs/ops/retail-ui/allocation/HEDGR_RETAIL_UI_ALLOCATION_VISUAL_PATTERN_COMPARISON.md`, `docs/ops/retail-ui/status-language/HEDGR_RETAIL_UI_PASS_RESOLUTION_NOTE.md` (**§6.2**), and `docs/ops/retail-ui/status-language/HEDGR_RETAIL_UI_MEANING_REFINEMENT_BRIEF.md` (**§6.2**).
...
Prototype and Paper precedent (`docs/ops/retail-ui/prototype/HEDGR_RETAIL_UI_PROTOTYPE_CRITIQUE_READOUT.md`, `docs/ops/retail-ui/paper/HEDGR_RETAIL_UI_PAPER_REVIEW_READOUT.md`) and shared criteria (`docs/ops/retail-ui/prototype/HEDGR_RETAIL_UI_CRITIQUE_SCORECARD.md`) inform vocabulary only; they do not convert this readout into implementation authority.
...
Allocation visual-pattern screening guidance is captured in `docs/ops/retail-ui/allocation/HEDGR_RETAIL_UI_ALLOCATION_VISUAL_PATTERN_GUARDRAILS.md`.
