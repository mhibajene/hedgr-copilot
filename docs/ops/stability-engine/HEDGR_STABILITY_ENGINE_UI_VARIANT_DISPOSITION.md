...
- **carry-forward patterns** consistent with `docs/ops/stability-engine/HEDGR_STABILITY_ENGINE_UI_EXPLORATION_NOTE.md`
...
| Document | Role |
|----------|------|
| `docs/ops/stability-engine/HEDGR_STABILITY_ENGINE_UI_EXPLORATION_NOTE.md` | **Governing exploration reference** for this lane (locked positions on anchor, terminology, CTA, `Advanced Details`, score, Atlas). |
