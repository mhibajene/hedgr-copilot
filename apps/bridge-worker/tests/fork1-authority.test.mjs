...
test("Fork 1 preserves projected occupancy, sequencing and all non-authorising flags", async () => {
  ...
  // The verified stimulus closeout supersedes the archived
  ...
  const currentSequencing = "Controlled Parallelism v22 / §6f.22 retains V/E parents while §285 defers G. §298 RETAINed the preflight; §299 closes only the implemented stimulus on effective source merge and separate RAP rebind, leaving no active nested Lane V ticket or successor. The weekend ticket remains deferred, not completed or cancelled. The separately released Digital Feedback v1 pulse and Founder-owned participant selection, invitations and raw-response custody continue under their existing conditions; moderated v2.1 and other parent distribution remain paused. The implemented research route is not released for participant use. No further runtime refinement, participant session, new Form, telemetry, personal-input collection, limited manipulation or “Use My Numbers” is activated. Lane E remains open without a nested ticket; §290 responsibilities remain non-executable and the current EngineState/posture is preserved. No Lane G restart, Green delegation, financial capability or cross-lane authority follows. NO CROSS-LANE IMPACT.";
