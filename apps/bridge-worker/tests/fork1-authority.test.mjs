...
test("Fork 1 preserves projected occupancy, sequencing and all non-authorising flags", async () => {
  ...
  const currentSequencing = "Controlled Parallelism v22 / §6f.22 retains V/E parents while §285 defers G. §301 occupies Lane V only with the documentation-only convergence package after its source merge and separate verified RAP rebind; §298 RETAINed the preflight and §§299–300 are completed history. The weekend ticket remains deferred, not completed or cancelled. The separately released Digital Feedback v1 pulse and Founder-owned participant selection, invitations and raw-response custody continue under their existing conditions; moderated v2.1 and other parent distribution remain paused. The research route is not released for participant use. No runtime refinement, participant session, new Form, telemetry, personal-input collection, limited manipulation or “Use My Numbers” is activated. Lane E remains open without a nested ticket; §290 responsibilities remain non-executable and the current EngineState/posture is preserved. No Lane G restart, Green delegation, financial capability or cross-lane authority follows. NO CROSS-LANE IMPACT.";
