...
test("Fork 1 preserves projected occupancy, sequencing and all non-authorising flags", async () => {
  ...
  const currentSequencing = "Controlled Parallelism v22 / §6f.22 retains V/E parents while §285 defers G. §301–§302 nested Lane V work is completed history; §303 Product Experience Lead registration is closed. §309 activates only `CLASS-A-VAL-002-RESEARCH-TWO-BEAT-001` after effective source merge and separate verified RAP rebind. The role-registry reconciliation is separate non-lane governance support and does not change that occupancy. The weekend ticket remains deferred, not completed or cancelled. The separately released Digital Feedback v1 pulse and Founder-owned participant selection, invitations and raw-response custody continue under their existing conditions; moderated v2.1 and other parent distribution remain paused. The Stability research route is not released for participant use. No participant session, new Form, response collection, telemetry, personal-input collection, limited manipulation or “Use My Numbers” is activated. Lane E remains open without a nested ticket; §290 responsibilities remain non-executable and current EngineState/posture is preserved. No Lane G restart, Green delegation, financial capability or cross-lane authority follows. NO CROSS-LANE IMPACT.";
