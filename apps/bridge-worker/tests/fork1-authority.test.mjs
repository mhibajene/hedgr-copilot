...
test("Fork 1 preserves projected occupancy, sequencing and all non-authorising flags", async () => {
  ...
  // The Founder-approved stimulus activation supersedes the archived
  ...
  const currentSequencing = "Controlled Parallelism v22 / §6f.22 retains V/E parents while §285 defers G. §298 retains and closes the documentation preflight; the sole next Lane V ticket is `CLASS-A-VAL-002-STABILITY-STIMULUS-001`, effective after source merge and separate RAP rebind. The weekend ticket remains deferred, not completed or cancelled. The separately released Digital Feedback v1 pulse and Founder-owned participant selection, invitations and raw-response custody continue under their existing conditions; moderated v2.1 and other parent distribution remain paused. Only the exact synthetic stimulus route, orientation branch and protocol in §7a are eligible for implementation. No participant session, new Form, telemetry, personal-input collection, limited manipulation or “Use My Numbers” is activated. Lane E remains open without a nested ticket; §290 responsibilities remain non-executable and the current EngineState/posture is preserved. No Lane G restart, Green delegation, financial capability or cross-lane authority follows. NO CROSS-LANE IMPACT.";
