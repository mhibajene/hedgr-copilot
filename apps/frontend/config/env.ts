...
export type Env = {
  ...
  NEXT_PUBLIC_DEFAULT_MARKET?: string;
  NEXT_PUBLIC_ENABLE_MARKET_SWITCHER?: string;
  NEXT_PUBLIC_FX_MODE?: string;
  NEXT_PUBLIC_MARKET_MODE?: string;
  NEXT_PUBLIC_MARKET_SELECTED?: string;
  OPENAI_MODE?: string;
...
function buildEnv(from: NodeJS.ProcessEnv): Env {
  ...
  const NEXT_PUBLIC_MARKET_MODE = from.NEXT_PUBLIC_MARKET_MODE?.trim() || process.env.NEXT_PUBLIC_MARKET_MODE?.trim();
  const NEXT_PUBLIC_MARKET_SELECTED = from.NEXT_PUBLIC_MARKET_SELECTED?.trim() || process.env.NEXT_PUBLIC_MARKET_SELECTED?.trim();
  ...
  return {
    ...
    ...(NEXT_PUBLIC_MARKET_MODE ? { NEXT_PUBLIC_MARKET_MODE } : {}),
    ...(NEXT_PUBLIC_MARKET_SELECTED ? { NEXT_PUBLIC_MARKET_SELECTED } : {}),
