...
export const ENGINE_STABILITY_REVIEW_CHANGE_DISCLAIMER =
  'This comparison is about system targets for this review only. It is not your ledger balances or whether funds moved.';
...
export const ENGINE_STABILITY_REVIEW_MEMORY_DISCLAIMER =
  'Saved only on this device for your orientation. It is not a record of balances, execution, or backend events.';
