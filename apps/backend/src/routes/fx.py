...
def fx_latest():
    ...
    if not pair:
        return error_response(DomainErrorCode.VALIDATION_ERROR, "pair is required", 400)
    ...
    return error_response(DomainErrorCode.NOT_IMPLEMENTED, "live FX not enabled", 501)
