...
**Current verification-only amendment:** Internal **D-096** / **§228** authorizes assertion reconciliation in only `apps/frontend/tests-e2e/orientation.spec.ts`, `apps/frontend/tests-e2e/balance-ssot.spec.ts`, `apps/frontend/tests-e2e/critical.spec.ts`, and `apps/frontend/tests-e2e/tx-lifecycle.spec.ts` so the protected full E2E workflow tests D-095 semantics and the preserved default non-synthetic lifecycle contract. D-096 creates no runtime, product, nested-ticket, lane, concurrency, participant-distribution, or financial-capability authority.
...
**Current verification-only amendment:** Internal **D-096** / **§228** authorizes assertion reconciliation in only `apps/frontend/tests-e2e/orientation.spec.ts`, `apps/frontend/tests-e2e/balance-ssot.spec.ts`, `apps/frontend/tests-e2e/critical.spec.ts`, and `apps/frontend/tests-e2e/tx-lifecycle.spec.ts`. It does not reopen D-095, activate a nested Lane V refinement, or authorize runtime, product, Form, distribution, Lane E, Lane N, or financial-capability change.
