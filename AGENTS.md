...
**Synthetic Home deposit CTA correction (2026-09-20):** The Founder now directs “Add simulated deposit” first as the filled primary action and “View activity” second as the secondary action on eligible synthetic Home. This is one fresh, finite correction to the completed §294 hierarchy inside the existing `CLASS-A-VAL-002-WEEKEND-PREP-001` ticket, under live §7/§7a/§295. Record source and DESIGN usage before RAP, merge and verify a separate permanent-main rebind before runtime; retain independent verification, hosted checks, deployed inspection, source-first completion and final rebind. Only the named action order/emphasis changes. The revised balance scope copy, default journey, routes, financial state, #550/Form, participant release pause, open parents, other lanes and inactive Fork 2/3 operating posture remain unchanged. No standing refinement follows.
