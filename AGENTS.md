...
**Current Lane V orientation-restructure activation override:** Internal **D-110** / **§242** activates `CLASS-A-VAL-002-ORIENT-003` as the sole active nested Lane V refinement inside open parent `CLASS-A-VAL-002`, superseding only stale statements that no nested Lane V refinement is active. Authority is limited to `apps/frontend/lib/narrative/orientation-surface.ts`, `apps/frontend/app/orientation/page.tsx`, `apps/frontend/__tests__/orientation-surface.test.ts`, `apps/frontend/tests-e2e/orientation.spec.ts`, and the named authority / generated-projection reconciliation. The surface must contain only identity, research status, material simulation / no-real-money / no-account / no-advice consequences, the real-data boundary, and permission to enter; it must remove pre-entry problem, category, benefit, behaviour, stability, allocation, liquidity, exit, and institutional-thesis coaching. Preserve the existing journey route/reset and legacy fallback seams, governed logo, live-Form gate, and participant-distribution pause. No Customer One-Pager, frozen narrative, Form, participant protocol, positioning, public category, Stability Wallet, currency-exposure, protection, control, diversification, dollarisation, FX, purchasing-power, product architecture, engine, Activity, Settings, Now / Reserve / Growth, financial capability, Lane E, Lane N, or cross-lane authority follows. `NO CROSS-LANE IMPACT`.
