...
description: "Migrated source command `adversarial-review`"
---

# source-command-adversarial-review

Use this skill when the user asks to run the migrated source command `adversarial-review`.
