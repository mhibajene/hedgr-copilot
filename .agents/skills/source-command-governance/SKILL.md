---
name: "source-command-governance"
description: "Migrated source command `governance`"
---

# source-command-governance

Use this skill when the user asks to run the migrated source command `governance`.
