---
name: "source-command-propose-next-ticket"
description: "Migrated source command `propose-next-ticket`"
---

# source-command-propose-next-ticket

Use this skill when the user asks to run the migrated source command `propose-next-ticket`.
