---
name: "source-command-execution"
description: "Migrated source command `execution`"
---

# source-command-execution

Use this skill when the user asks to run the migrated source command `execution`.
