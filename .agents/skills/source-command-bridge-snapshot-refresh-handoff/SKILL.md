---
name: "source-command-bridge-snapshot-refresh-handoff"
description: "Migrated source command `bridge-snapshot-refresh-handoff`"
---

# source-command-bridge-snapshot-refresh-handoff

Use this skill when the user asks to run the migrated source command `bridge-snapshot-refresh-handoff`.
